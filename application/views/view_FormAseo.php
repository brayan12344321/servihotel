...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div data-role="header" position="fixed">
        <div class="title"><a href="<?php echo base_url(); ?>servicio "><img src="<?php echo base_url(); ?>img/volver.png" alt="" style="float:left"></a><h1>¿Que nesecitas?</h1></div>
      </div>
          ...
          <form  action="index.html" method="post" style="width:80%; margin-top:20px">
            <div class="select">
              <select class="" name="">
                ...
                <option value="">Utencilios</option>
              </select>
            </div>
          <div class="input">
              <input type="text" name="" placeholder="Numero Pieza" >
          </div>
          <div class="submit">
