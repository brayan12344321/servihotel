...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>ServiHotel/Utencilios</title>
  ...
  <body>
    ...
    <div data-role="main">
      ...
      <div class="tipoAseo mt-4">
        ...
        <div class="aseo">
          <a href="<?php echo base_url(); ?>limpieza"><h5 class="text-center" >Limpieza</h5></a>
        </div>
        <div class="aseo" id="aseo2">
          <a href="<?php echo base_url(); ?>utencilios"><h5 class="text-center" style="color:#fb797b;background-color: #fff; padding: 10px;">Utencilios</h5></a>
        </div>
      </div>
      <center><div class="container">
        <h4 class="mt-5">Que te hace falta en tu habitacion?</h4>
