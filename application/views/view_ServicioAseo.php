...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>ServiHotel/Servicio/Aseo</title>
  ...
  <body>
    ...
    <div data-role="main">
      ...
      <center><div class="container">
        <h4 class="mt-5">Escribe tu Orden:</h4>
        <form class="" action="<?php echo base_url(); ?>ServicioAseo/insertarservicio/<?php echo $this->session->userdata('ID');  ?>" method="post" data-ajax="false">
          <div class="input">
